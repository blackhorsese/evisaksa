    ...
    <>
        <div className='mx-auto justify-center items-center md:px-10 px-5 py-5 md:mt-72'>
            <div className='max-w-screen-2xl justify-center mx-auto'>
                <div className='lg:flex grid-cols-3 items-center justify-between rounded-md md:gap-10 md:border mt-10 md:mt-20 bg-[#78006E] text-white'>
                    ...
                    <div className='w-full hidden lg:block md:max-w-5xl'>
                        <img className='' src='./emergence.jpg' alt='images'/>
                    </div>
                </div>
                <div className='md:flex gap-10 items-center mx-auto md:py-20 py-10'>
                        <div className='border border-opacity-20 rounded-md md:pb-20 pb-10 max-w-md md:h-80 md:mt-0 mt-5'>
                            <h1 className='bg-[#78006E] text-white md:text-lg text-base font-semibold py-4 px-3'>
                                Tourism
                            </h1>
                    ...
                    <div className='lg:flex items-center justify-between rounded-md md:gap-10 md:border md:mt-20 text-black'>
                    <div className='w-full lg:hidden block'>
                        <img className='hidden lg:block md:block xl:block' src='./telecomr.jpg' alt='images'/>
                    </div>
                    <div className='md:px-10 px-5 py-5'>
                        <h1 className='lg:pt-5 pt-3 lg:text-2xl text-xl font-semibold'>
                    ...
                    <div className='w-full hidden lg:block md:max-w-5xl'>
                        <img className='' src='./telecomr.jpg' alt='images'/>
                    </div>
                </div>
