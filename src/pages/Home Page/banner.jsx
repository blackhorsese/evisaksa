...
export default function banner() {
  return (
    <>
      ...
      <div className='justify-center mx-auto items-center bg-[#403f68] text-white xl:mt-0 xl:px-20 xl:py-10 xl:mx-0 lg:mx-0 lg:py-5 lg:mt-0 md:px-8 md:mx-0 md:mt-0 md:py-5 px-10'>
