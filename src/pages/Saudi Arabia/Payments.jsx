            ...
            <div className='max-w-screen-2xl justify-center mx-auto'>
                ...
                <div className='lg:flex items-center justify-between rounded-md md:gap-10 md:border'>
                    <div className='w-full'>
                        <img className='' src='./exchange.jpg' alt='images'/>
                    </div>
                ...
                <div className='lg:flex bg-[#78006E] items-center justify-between lg:mt-28 rounded-md'>
                    <div className='max-w-screen-2xl lg:text-base text-sm lg:px-20 text-white px-5 py-10'>
                        ...
                        className="
                        items-center lg:text-base text-sm bg-white rounded-full lg:w-44 w-40 border-[#78006E] relative h-10 duration-200 mt-5 lg:px-8 md:px-4 px-4 flex flex-row text-[#78006E] font-semibold tracking-wide"
                        >
                            Download
                        </a>
                    </div>
