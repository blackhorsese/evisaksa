        ...
        <Box 
            ...
            >
                ...
                <div className='items-center text-left bg-[#403F68] pt-10 mt-10 pb-52'>
                    <Tabs className='border-[#ffffff] border-b border-opacity-20 max-w-screen-2xl mx-auto'
                        value={value}
                    ...
                    <TabPanel value={value} index={0}>
                        <div className='lg:flex items-center justify-between rounded-md gap-10 border md:-mt-40 -mt-44 bg-white'>
                            <div className='lg:hidden block'>
                                <img className='' src='./travel_essential/about_saudi/mid_march_to_mid_june.png' alt='images'/>
                            </div>
