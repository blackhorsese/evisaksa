        ...
        <form onSubmit={handleSubmit} className="">
          {step === 1 && (
            <div className="grid grid-cols-1 md:grid-cols-3">
              ...
              <div className="md:col-span-2 md:ml-[300px] lg:ml-[400px] xl:ml-[500px] md:w-[75%] mx-auto w-[90%]">
                ...
                <div className="mt-10 ">
                  <label className="text-[#403F68] font-medium ">
                ...
                <div className="mt-10 ">
                  <label className="text-[#403F68] font-medium ">Gender*</label>
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">Profession*</label>
                  <br />
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">Country*</label>
                  <br />
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">City*</label>
                  <br />
                  <input
                    type="text"
                    value={city}
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">Address*</label>
                  <br />
                  <input
                    type="text"
                    value={address}
                ...
                <button 
                  className="ml-5 text-[#403F68] md:text-lg text-sm border-4 border-[#403F68] md:w-64 w-48 items-center p-3 rounded-full block self-end my-10" 
          ...
          {step === 2 && (
            <div className="grid grid-cols-1 md:grid-cols-3">
              ...
              <div className="md:col-span-2 md:ml-[300px] lg:ml-[400px] xl:ml-[500px] md:w-[75%] mx-auto w-[90%]">
                <div className="mt-10 ">
                  <p className="uppercase text-[15px] mt-5 mb-10 font-medium bg-gray-100 p-5 border-l-2 border-[#78006E]">
                    Passport Traveler
                  </p>
                  <label className="text-[#403F68] font-medium ">
                    Passport Type*
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">Passport No*</label>
                  <br />
                  <input
                    type="text"
                    value={passportno}
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">Address 1*</label>
                  <br />
                  <input
                    type="text"
                    value={address1}
                ...
                <div className="mt-10">
                  <label className="text-[#403F68] font-medium ">Address 2*</label>
                  <br />
                  <input
                    type="text"
                    value={address2}
                ...
                <div className="md:flex justify-between">
                  ...
                  <div className="mt-10">
                    <label className="text-[#403F68] font-medium">Email</label>
                    <br />
                    <input
                      type="mail"
                      value={email}
