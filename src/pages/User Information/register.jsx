        ...
        <form onSubmit={handleSubmit} className="md:col-span-2 md:ml-[300px] lg:ml-[400px] xl:ml-[500px] md:w-[75%] mx-auto w-[90%] ">
          {step === 1 && (
            <div>
              ...
              <div className="mt-10 ">
                <label className="text-[#78006E] font-medium ">
              ...
              <div className="mt-10 ">
                <label className="text-[#78006E] font-medium ">Gender*</label>
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">Profession*</label>
                <br />
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">Country*</label>
                <br />
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">City*</label>
                <br />
                <input
                  type="text"
                  value={city}
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">Address*</label>
                <br />
                <input
                  type="text"
                  value={address}
              ...
              <button 
                className="ml-5 text-[#78006E] md:text-lg text-sm border-4 border-[#78006E] md:w-64 w-48 items-center p-3 rounded-full block self-end my-10" 
          ...
          {step === 2 && (
            <div>
              <p className="mt-10 text-[15px] font-medium bg-gray-100 p-5 border-l-2 border-[#78006E]">
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">Passport No*</label>
                <br />
                <input
                  type="text"
                  value={passportno}
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">Address 1*</label>
                <br />
                <input
                  type="text"
                  value={address1}
              ...
              <div className="mt-10">
                <label className="text-[#78006E] font-medium ">Address 2*</label>
                <br />
                <input
                  type="text"
                  value={address2}
              ...
              <div className="md:flex justify-between">
                ...
                <div className="mt-10">
                  <label className="text-[#78006E] font-medium">Email</label>
                  <br />
                  <input
                    type="mail"
                    value={email}
