...
export default function VerticalTabs() {
  ...
  return (
    <>
    <div className='max-w-screen-2xl mx-auto md:text-5xl md:px-10 px-5 text-3xl font-displace border-t-4 border-[#78006E] py-10'>
        <h1>
            General Health FAQ
        </h1>
    </div>
    <Box 
        className="mx-auto px-5 justify-between md:px-10 pb-52 max-w-screen-2xl"
        >
