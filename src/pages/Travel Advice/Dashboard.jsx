    ...
    <>
        <div className='duration-500'>
            <div className='bg-local md:h-32 h-44'>
                <img className='z-0 duration-500 w-full object-cover h-[12rem] md:h-[36rem]' src='./travel_essential/saifty_travel_tips/health-and_safety_travel_tips.png' alt='images'/>
            </div>
