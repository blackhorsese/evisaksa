            ...
            <div className='max-w-screen-2xl justify-center mx-auto'>
                ...
                <div className='md:flex md:grid-cols-3 gap-10 md:pt-10'>
                    ...
                    <div className='border border-opacity-20 rounded-md pb-5 md:mt-0 mt-10'>
                        ...
                        <div className='mt-10 border-t mx-5 py-2 border-[#403F68] border-opacity-20'>
                            <a href='https://www.sar.com.sa/' target='_blank' className='text-[#0600FF]'>
                                Learn more 
                            </a>
                        </div>
                    </div>
                    <div className='border border-opacity-20 rounded-md pb-5 md:mt-0 mt-10'>
                        ...
                        <div className='mt-10 border-t mx-5 py-2 border-[#403F68] border-opacity-20'>
                            <a href='https://sar.hhr.sa/home#' target='_blank' className='text-[#0600FF]'>
                                Learn more 
                            </a>
                        </div>
                    </div>
