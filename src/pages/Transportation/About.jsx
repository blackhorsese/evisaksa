        ...
        <div className='max-w-screen-2xl justify-center mx-auto'>
            <div className='items-center justify-center'>
                <div className='justify-center'>
                    <h1 className='py-5 lg:text-5xl text-3xl text-[#403F68] font-displace'>
                    ...
                    <div className='md:max-w-screen-lg justify-center'>
                        <a className='pt-5 md:max-w-screen-xl xl:text-base lg:text-base md:text-base text-sm'>
                            ...
                            <a href="https://www.saudia.com/" target="_blank" className='text-[#0600FF]'> Saudia,
                            </a>
                            <a href="https://www.flynas.com/en" target="_blank" className='text-[#0600FF]'> Flynas
                            </a> and
                            <a className='text-[#0600FF]' href="https://www.flyadeal.com/en" target="_blank"> Flyadeal.
                            </a>
                        </a>
                    </div>
                </div>
