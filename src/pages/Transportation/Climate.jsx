            ...
            >
                ...
                <div className='mx-auto max-w-screen-2xl justify-center md:px-10 px-5 items-center'>
                    <TabPanel value={value} index={0}>
                        <div className='lg:flex items-center justify-between rounded-md gap-10 border md:-mt-40 -mt-44 bg-white'>
                            <div className='lg:hidden block'>
                                <img className='' src='./rentcar.jpg' alt='images'/>
                            </div>
                            <div className='md:px-20 md:max-w-xl px-5 md:pb-0 lg:pb-0 pb-5'>
                                <h1 className='lg:pt-5 pt-3 md:text-4xl text-2xl text-[#78006E]'>
                                    Car rentals
                                </h1>
                    ...
                    <TabPanel value={value} index={1}>
                        <div className='lg:flex items-center justify-between rounded-md gap-10 border md:-mt-40 -mt-44 bg-white'>
                            <div className='lg:hidden block'>
                                <img className='' src='./taxis.jpg' alt='images'/>
                            </div>
                            <div className='md:px-20 md:max-w-xl px-5 md:pb-0 lg:pb-0 pb-5'>
                                <h1 className='lg:pt-5 pt-3 md:text-4xl text-2xl text-[#78006E]'>
                                    Taxis
                    ...
                    <TabPanel value={value} index={2}>
                        <div className='lg:flex items-center justify-between rounded-md gap-10 border md:-mt-40 -mt-44 bg-white'>
                            <div className='lg:hidden block'>
                                <img className='' src='./app.jpg' alt='images'/>
                            </div>
                            <div className='md:px-20 md:max-w-xl px-5 md:pb-0 lg:pb-0 pb-5'>
                                <h1 className='lg:pt-5 pt-3 md:text-4xl text-2xl text-[#78006E]'>
                    ...
                    <TabPanel value={value} index={3}>
                        <div className='lg:flex items-center justify-between rounded-md gap-10 border md:-mt-40 -mt-44 bg-white'>
                            <div className='lg:hidden block'>
                                <img className='' src='./buses.jpg' alt='images'/>
                            </div>
                            <div className='md:px-20 md:max-w-xl px-5 md:pb-0 lg:pb-0 pb-5'>
                                <h1 className='lg:pt-5 pb-5 pt-3 md:text-4xl text-2xl text-[#78006E]'>
                                    Buses
                                </h1>
                                <a className='pt-5 text-sm font-light text-[#1b1b1b]'>
                                    ...
                                    <a className='text-[#78006E]' href='https://saptco.com.sa/homepage' target='_blank'> SAPTCO website.
                                    </a>
                                </a>
