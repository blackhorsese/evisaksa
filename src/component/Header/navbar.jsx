...
function Logo({ isScrolled }) {
  ...
  return (
    <>
      {isScrolled ? (
            <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#E0E0E9] md:py-2 md:border-b">
              <div className='w-full z-20 border-b pb-1 lg:block md:block hidden bg-[#403F68]'>
                      ...
                      <div className="items-center flex flex-row space-x-2 justify-end duration-500">
                        <div className='flex pl-8 items-center'>
                          <a
                            ...
                            items-center text-base md:text-sm md:hover:border-b border-[#A39896] relative h-8 duration-200 lg:px-8 md:px-4 px-4 flex justify-center flex-row text-[#403f68] font-bold tracking-wide"
                          >
                            Home
                          </a>
                          <NavLinks />
                          <a
                            href="/register"
                            className="
                            items-center text-base md:text-sm hover:bg-[#403f68] hover:text-[#fff] rounded-full border-[#403f68] border relative h-10 duration-200 lg:px-8 md:px-4 px-4 flex justify-center flex-row text-[#403f68] font-semibold tracking-wide"
                          >
                            Apply for eVisa
                          </a>
                        </div>
              ...
              >
                ...
                <li>
                  <Link to="/register" className="hover:bg-[#A39896] border border-[#A39896] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Apply for eVisa
                  </Link>
                </li>
                <li> 
        ...
        <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:py-2 hover:bg-[#403f68]">
              ...
              <div className="items-center flex flex-row space-x-2 justify-end duration-500">
                <div className='flex pl-8 items-center'>
                  <a
                    ...
                    items-center text-base md:text-sm md:hover:border-b border-[#A39896] relative h-8 duration-200 lg:px-8 md:px-4 px-4 flex justify-center flex-row text-[#fff] font-bold tracking-wide"
                  >
                    Home
                  </a>
                  <Navlinksblack />
                  <a
                    href="/register"
                    className="
                    items-center text-base md:text-sm bg-black bg-opacity-10 hover:bg-opacity-5 rounded-full border-[#A39896] relative h-10 duration-200 lg:px-8 md:px-4 px-4 flex justify-center flex-row text-[#fff] font-semibold tracking-wide"
                  >
                    Apply for eVisa
                  </a>
      ...
      {/* Mobile nav */}
        <ul className={`md:hidden bg-[#111316] fixed w-full top-0 overflow-y-auto bottom-0 py-20 duration-500 ${open ? "left-0" : "left-[-100%]"}
              ...
              >
                <li>
                  <Link to="/" className="tracking-wider hover:bg-[#1a1e24] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#A39896] text-[#fff] border-[#ffffff] border-opacity-10 text-sm font-semibold">
                    Home
                  </Link>
                </li>
                <Navlinksblack/>
                ...
                <li>
                  <Link to="/register" className="hover:bg-[#A39896] text-[#C3CDD3] border border-[#A39896] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Apply for eVisa
                  </Link>
                </li>
                <Link to="/contact-us" className="hover:bg-[#A39896] text-[#C3CDD3] border border-[#A39896] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Contact Us
                  </Link>
              </ul>
    </header>
