...
//   return (
//     <React.Fragment>
//       <div className="bg-[#78006E] py-5 overflow-hidden">
//         <div className="grid grid-cols-1  md:grid-cols-3 py-5 border-b-[1px] bg-[#78006E] w-[95%] mx-auto">
              ...
              <div className='bg-[#78006E] overflow-hidden'>
                <div className='max-w-screen-xl mx-auto justify-center md:pt-20 md:pb-10 md:px-10 py-10'>
                  <h1 className='text-[#fff] md:text-base text-sm justify-center pb-5 px-5 '>
                    Website last updated: December 12, 2023
                  </h1>
                  <div className='md:grid md:grid-cols-4 md:gap-8 max-w-screen-2xl mx-auto justify-center py-5 text-white px-7'>
                    <div className="py-2 md:px-0 px-2">
                      <a href="/">
                        <img src='./Mainlogo.png' className='md:w-52 w-40' alt='favicon.png'/>
                      </a>
                    </div>
                    <div className='md:mt-0 mt-5'>
                      ...
                      <ul className='pt-3'>
                        <li className='pl-2 hover:font-semibold duration-150'>
                          <a className='text-sm text-[#C3CDD3] hover:text-[#fff]' 
