...
const slides = [
    ...
    {
        eachSlide: 'url(./makkah.jpg)',
        heading: 'Al-Makkah',
        text: 'The Grand Mosque receives great care, using the finest materials and innovative technologies to serve pilgrims, whose number exceeds millions per year. Over 24 hours,'
    },

    {
        eachSlide: 'url(./Jiranah.jpg)',
...
const Dashboard = () => {
    ...
    const renderSlides = () => slides.map((item, index) => (
        <div 
            ...
            className='text-white bg-black bg-opacity-50 lg:mx-44 lg:mt-80 md:py-8 md:pt-16 mt-32 items-center py-20 mx-10 px-5 justify-center text-center relative'>
