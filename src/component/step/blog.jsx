  ...
  return (
    ...
    <div className='md:px-10 items-center mx-auto justify-center px-5 py-20'>
      <div className='max-w-screen-2xl mx-auto justify-center'>
        <h1 className='py-10 lg:text-4xl text-2xl font-displace'>
          Know Before You Go
        </h1>
        <div className='flex md:grid-cols-4 overflow-x-scroll md:overflow-hidden lg:overflow-hidden mx-auto gap-5 md:gap-10 justify-between items-center'>
          <a href='/about-saudi' className='justify-center hover:bg-[#f1f1f1] border-[#78006E] border-opacity-20 border rounded-xl shadow-xl'>
            <div className='px-3 lg:h-96 h-80 py-4 items-center w-72 lg:w-[22rem]'>
              <img className='w-96' src='./1.jpg' alt='images'/>
        ...
        <div className='lg:flex bg-[#78006E] items-center justify-between lg:mt-28 mt-20 rounded-md'>
          <div className='max-w-screen-2xl lg:text-base text-sm lg:px-20 text-white px-5 py-10'>
            ...
            <a
              href="/"
              className="
              items-center lg:text-base text-sm bg-white rounded-full lg:w-64 w-44 border-[#78006E] relative h-10 duration-200 mt-5 lg:px-8 md:px-4 px-4 flex flex-row text-[#78006E] font-semibold tracking-wide"
            >
              View Requirements
            </a>
          </div>
