...
export default function VerticalTabs() {
  ...
  return (
    <>
    <div className='max-w-screen-2xl mx-auto md:text-5xl md:px-10 px-5 text-3xl font-displace'>
        <h1>
            Frequently Asked Questions
        </h1>
    </div>
    <Box 
        className="mx-auto px-5 justify-between md:px-10 pt-10 pb-52 max-w-screen-2xl"
        >
            ...
            >
                <Tab
                    ...
                    sx={{
                        ...
                        textTransform: 'none',
                        '&.Mui-selected': {
                            color: '#78006E', // Change the text color to #78006E for the selected tab
                        }
                    }}
                />
                <Tab
        ...
        <div className='mx-auto max-w-screen-xl mt-10'>
            <TabPanel value={value} index={0}>
                <Fragment>
                    ...
                    <Accordion open={open === 6} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(6)}>
                    ...
                    <Accordion open={open === 7} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(7)}>
                    ...
                    <Accordion open={open === 8} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(8)}>
            ...
            <TabPanel value={value} index={1}>
                <Accordion open={open === 9} animate={customAnimation}>
                    <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(9)}>
                    ...
                    <Accordion open={open === 10} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(10)}>
                    ...
                    <Accordion open={open === 11} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(11)}>
                    ...
                    <Accordion open={open === 12} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(12)}>
                    ...
                    <Accordion open={open === 13} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(13)}>
                    ...
                    <Accordion open={open === 14} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(14)}>
                ...
                <TabPanel value={value} index={2}>
                    <Accordion open={open === 15} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(15)}>
                    ...
                    <Accordion open={open === 16} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(16)}>
                    ...
                    <Accordion open={open === 17} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(17)}>
                    ...
                    <Accordion open={open === 18} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(18)}>
                    ...
                    <Accordion open={open === 19} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(19)}>
                    ...
                    <Accordion open={open === 20} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(20)}>
                    ...
                    <Accordion open={open === 21} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(21)}>
                ...
                <TabPanel value={value} index={3}>
                    <Accordion open={open === 22} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(22)}>
                    ...
                    <Accordion open={open === 23} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(23)}>
                    ...
                    <Accordion open={open === 24} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(24)}>
                    ...
                    <Accordion open={open === 25} animate={customAnimation}>
                        <AccordionHeader className="font-semibold text-[#000] border-[#000] items-center border-opacity-20 text-sm md:text-base border-b text-left py-6" onClick={() => handleOpen(25)}>
