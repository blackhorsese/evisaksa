          ...
          {asias.map((user) => (
            <div className="flex py-3">
              <img
                ...
                src={user.img}
              />
              <p className="ml-4 md:text-[15px] text-xs self-center">{user.name}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-3 lg:grid-cols-6 mx-auto mt-5">
          <div className="flex py-3">
            <img
              ...
              src={Australia}
            />
            <p className="ml-4 md:text-[15px] text-xs self-center">AUSTRALIA</p>
          </div>
          <div className="flex ml-8 py-3">
            <img
              ...
              src={Australia}
            />
            <p className="ml-4 md:text-[15px] text-xs self-center">NEW ZEALAND</p>
          </div>
        </div>
      </div>

      <div className="pt-5 pb-10 max-w-screen-2xl md:px-10 px-5 mx-auto justify-center">
        <div>
          <p className="">
